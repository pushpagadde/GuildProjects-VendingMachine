...
public class SuperHeroDaoImpl implements SuperHeroDao{
    ...
    private static final String SQL_UPDATE_HEROORG
        = "update heroorganization set organizationid = ? where heroid = ?";
    ...
    public void updateHero(SuperHero hero, int organizationID) {
        ...
        jdbcTemplate.update(SQL_UPDATE_HEROORG,organizationID, hero.getHeroID());
    }        
