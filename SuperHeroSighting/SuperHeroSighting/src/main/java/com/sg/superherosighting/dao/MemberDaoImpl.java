...
public class MemberDaoImpl implements MemberDao{
    ...
    private static final String SQL_ADD_ORGMEMBER
            ="insert into organizationmember (organizationID, memberID) values (?,?)";
    private static final String SQL_UPDATE_MEMBERORG
            ="update organizationmember set organizationid = ? where memberid = ?";
    
    
    @Override
    @Transactional(propagation = Propagation.REQUIRED, readOnly = false)
    public void addMember(Member member, int organizationID) {
        ...
        jdbcTemplate.update(SQL_ADD_ORGMEMBER, organizationID, memberID);
    }
    @Override
    @Transactional(propagation = Propagation.REQUIRED, readOnly = false)
    ...
    @Override
    public void updateMember(Member member, int organizationID) {
        jdbcTemplate.update(SQL_UPDATE_MEMBER,
                ...
                member.getZipCode(),
                member.getMemberID());
        jdbcTemplate.update(SQL_UPDATE_MEMBERORG, organizationID , member.getMemberID());
    }
    @Override
